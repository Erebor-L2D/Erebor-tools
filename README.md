# Welcome to the Erebor Global fit codebase!

This repository contains useful tools for interacting with the Erebor codebase, work with its results, and delve into its details.
